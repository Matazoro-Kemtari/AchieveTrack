...
public class DuplicateWorkDateEmployeeErrorCollectionViewModel : BindableBase, IDestructible, IValidationErrorCollectionViewModel
{
    private readonly IValidationError _model;

    public DuplicateWorkDateEmployeeErrorCollectionViewModel(IValidationError validationResult)
    {
    ...
    [Logging]
    internal static DuplicateWorkDateEmployeeErrorCollectionViewModel Create(IValidationError validationResult)
