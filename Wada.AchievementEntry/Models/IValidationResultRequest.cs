...
{
    private InvalidWorkNumberResultRequest(WorkingNumber workingNumber, string note)
        : base(workingNumber, note)
    { }

    private static new InvalidWorkNumberResultRequest Create(WorkingNumber workingNumber, string note)
...
{
    private DuplicateWorkDateEmployeeResultRequest(WorkingNumber workingNumber, string note)
        : base(workingNumber, note)
    { }

    private static new DuplicateWorkDateEmployeeResultRequest Create(WorkingNumber workingNumber, string note)
        => new(workingNumber, note);
...
{
    private UnregisteredWorkNumberResultRequest(WorkingNumber workingNumber, string note)
        : base(workingNumber, note)
    { }

    private static new UnregisteredWorkNumberResultRequest Create(WorkingNumber workingNumber, string note)
        => new(workingNumber, note);
...
{
    private WorkDateExpiredResultRequest(WorkingNumber workingNumber, string note)
        : base(workingNumber, note)
    { }

    private static new WorkDateExpiredResultRequest Create(WorkingNumber workingNumber, string note)
        => new(workingNumber, note);
